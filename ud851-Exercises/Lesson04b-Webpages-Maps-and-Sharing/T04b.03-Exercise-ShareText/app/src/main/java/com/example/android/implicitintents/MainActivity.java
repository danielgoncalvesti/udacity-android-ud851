...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickShareTextButton(View v) {
        ...
        String stringToShare = "I want to share this by Daniel Goncalves";

        // COMPLETED (6) Replace the Toast with shareText, passing in the String from step 5
        shareText(stringToShare);
//        Toast.makeText(this, "TODO: Share text when this is clicked", Toast.LENGTH_LONG).show();
    ...
    public void shareText(String txtToShare) {
        ...
        String title = "Title to share something";
